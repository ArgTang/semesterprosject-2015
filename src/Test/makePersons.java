...
public class makePersons {
    ...
    private final static String[] boysName = {"Lukas", "William", "Marcus", "Emil", "Oskar", "Matias",	"Magnus", "Philip", "Jakob", "Aksel","Henrik","Isak","Isaac","Noah","Oliver","Jonas","Elias","Liam","Kasper","Casper","Sander","Alexander","Kristian","Christian","Tobias","Leon","Theodor","Sebastian","Daniel","Benjamin","Matheo","Adrian","Mohammad","Mohammed","Johannes","Martin","Nikolai","Nicolay","Olav","Håkon","Ludvig","Ludvik","Theo","Andreas","Erik","Eric","Jonathan","Hermann","Odin","Victor","Viktor","Sigurd","Mikkel","Kristoffer","Christopher","Marius","Fredrik","Frederick","Even","Ole" };
